...
class LiquidityAdjustedFee:
    ...
    def calculate_opportunity_cost(self, capital: Decimal, days: int) -> Decimal:
        ...
        return (capital * (compound_factor - Decimal("1"))).quantize(Decimal("0.01"), rounding=ROUND_HALF_UP)
    ...
    def calculate_gem_profit(
        ...
        revenue_multiplier = (Decimal("1") - self.cfg.WAX_SELLING_FEE) * (Decimal("1") - self.cfg.WAX_CASHOUT_FEE)
