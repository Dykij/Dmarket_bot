...
async def show_balance(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        message = f"❌ Ошибка: {e}"
    keyboard = [[InlineKeyboardButton("🔄 Обновить", callback_data="show_balance")], [InlineKeyboardButton("◀️ Главное меню", callback_data="main_menu")]]
...
async def show_inventory(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        message = f"❌ Ошибка: {e}"
    keyboard = [[InlineKeyboardButton("🔄 Обновить", callback_data="show_inventory")], [InlineKeyboardButton("◀️ Главное меню", callback_data="main_menu")]]
    await query.edit_message_text(message, parse_mode="HTML", reply_markup=InlineKeyboardMarkup(keyboard))
