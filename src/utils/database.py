    ...
    def async_engine(self) -> AsyncEngine:
        ...
        if self._async_engine is None:
            ...
            if async_url.startswith("postgresql://"):
                ...
                async_url = async_url.replace("sqlite:///", "sqlite+Algoosqlite:///")
            ...
            if "sqlite" in async_url and not is_memory:
                # Algoosqlite specific connection arguments
                kwargs["connect_args"] = {
                    "timeout": 30,
    ...
    async def get_db_status(self) -> dict[str, Any]:
        ...
        if self._async_engine:
            try:
                ...
                status["async_engine"] = "Initialized (pool stats unavAlgolable)"
