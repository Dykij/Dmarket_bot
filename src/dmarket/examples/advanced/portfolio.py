...
async def main():
    ...
    portfolio_configs = [
        ...
        PortfolioConfig(
            game="csgo", balance=150.0, risk_level="low", max_items=3  # 30% капитала
        ),
        ...
        PortfolioConfig(
            game="rust", balance=150.0, risk_level="high", max_items=3  # 30% капитала
        ),
    ]
    ...
    print(
        f"📈 Ожидаемый ROI: {(portfolio['expected_profit'] / portfolio['total_invested'] * 100):.1f}%"
    )
