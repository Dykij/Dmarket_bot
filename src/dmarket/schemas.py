...
class MarketItemSchema(pa.DataFrameModel):
    ...
    suggested_price: Series[float] = pa.Field(alias="suggestedPrice", nullable=True, coerce=True)
...
class MarketItem(BaseModel):
    ...
    title: str
    price: dict[str, str | int] | float  # DMarket returns weird price structures sometimes
