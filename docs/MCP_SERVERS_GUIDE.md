...
MCP позволяет Algo-агентам взаимодействовать с внешними сервисами через стандартизированный протокол.
...
| **hummingbot** | Algo-трейдинг автоматизация | `HUMMINGBOT_API_KEY` |
...
- Контекст для Algo-рекомендаций
...
awAlgot client.remember_preference(
    user_id=123456,
...
# Получить контекст для Algo
context = awAlgot client.get_user_context(123456)
```
...
### Возможности
- Algo-driven торговая автоматизация
...
- [SuperMemory](https://supermemory.Algo/)
