...
> **⚠️ Адаптация домена**: Этот скилл изначально написан для крипто-трейдинга (Solana/DEX/AMM/токены).
> При применении к DMarket-боту (торговля скинами CS2) используй ТОЛЬКО общую статистическую/
> математическую методологию ниже. Полностью игнорируй все упоминания Solana, DEX, AMM, USDC,
> BTC/ETH и подобных крипто-специфичных механизмов — они не относятся к ордербуку DMarket.
