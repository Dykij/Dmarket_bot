...
## 🆕 Modular Skills (2026 Standard)

The project utilizes a modular skills architecture for rapid capability expansion:
...
cp .env.example .env
```
*Required:* `TELEGRAM_BOT_TOKEN`, `DMARKET_PUBLIC_KEY`, `DMARKET_SECRET_KEY`.
