...
class TestMCPAvAlgolability:
    ...
    def test_mcp_not_installed_raises_error(self) -> None:
        ...
        with patch.dict(
            ...
            # Re-import to trigger avAlgolability check
            pass  # Skip actual test since we can't easily unload modules

    def test_mcp_avAlgolable_constant(self) -> None:
        """Test MCP_AVAlgoLABLE constant exists."""
        ...
        try:
            from src.mcp_server.dmarket_mcp import MCP_AVAlgoLABLE
...
# =============================================================================
# Tests for DMarketMCPServer initialization (when MCP is not avAlgolable)
# =============================================================================
