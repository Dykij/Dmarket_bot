...
def _make_mixin() -> MagicMock:
    ...
    mixin._extract_item_attributes = _FilterMixin._extract_item_attributes.__get__(mixin)
    mixin._apply_float_and_dirty_premiums = _FilterMixin._apply_float_and_dirty_premiums.__get__(mixin)
    mixin._apply_demand_and_pattern_premiums = _FilterMixin._apply_demand_and_pattern_premiums.__get__(mixin)
    mixin._apply_sticker_modifiers = _FilterMixin._apply_sticker_modifiers.__get__(mixin)
    mixin._apply_float_date_premium = _FilterMixin._apply_float_date_premium.__get__(mixin)
